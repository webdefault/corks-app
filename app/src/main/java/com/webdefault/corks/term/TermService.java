...
import com.offsec.nhterm.Term;
import com.offsec.nhterm.TermDebug;
import com.offsec.nhterm.TermExec;
...
{
	private static final String LOG_TAG = "TermService";
	...
	private final IBinder mTSBinder = new TermService.TSBinder();
	...
	public IBinder onBind( Intent intent )
	{
		if( TermExec.SERVICE_ACTION_V1.equals( intent.getAction() ) )
		{
			...
			return new TermService.RBinder();
		}
		else
		{
						...
						new Handler(Looper.getMainLooper()).post(new Runnable() {
							...
							public void run() {
								...
								try {
									...
									session.setFinishCallback(new TermService.RBinderCleanupCallback(result, callback));
									session.setTitle("");
