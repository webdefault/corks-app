...
public class ShellTermSession extends GenericTermSession {
    ...
    private void initializeSession(String mShell) throws IOException {
        ...
        env[1] = "HOME=/data/data/com.webdefault.corks/files/";
        env[2] = "PATH=/data/data/com.webdefault.corks/files/usr/bin:/data/data/com.webdefault.corks/files/usr/bin/applets:" + path;
        env[3] = "PREFIX=/data/data/com.webdefault.corks/files/usr";
        env[4] = "PS1=$ ";
        env[5] = "LD_LIBRARY_PATH=/data/data/com.webdefault.corks/files/usr/lib";
        env[6] = "LANG=en_US.UTF-8";
        env[7] = "PWD=/data/data/com.webdefault.corks/files/home";
        env[8] = "ANDROID_ROOT=/system";
        env[9] = "ANDROID_DATA=/data";
        env[10]= "EXTERNAL_STORAGE=/sdcard";
        env[11]= "TMPDIR=/data/data/com.webdefault.corks/files/tmp";
        env[12]= "PROOT_TMP_DIR=/data/data/com.webdefault.corks/files/proot_tmp";
